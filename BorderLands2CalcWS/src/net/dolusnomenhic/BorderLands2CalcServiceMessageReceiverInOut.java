...
/**
 * BorderLands2CalcServiceMessageReceiverInOut.java
 *
 ...
 */
        ...
        /**
        *  BorderLands2CalcServiceMessageReceiverInOut message receiver
        */

        public class BorderLands2CalcServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver{
        ...
        BorderLands2CalcServiceSkeleton skel = (BorderLands2CalcServiceSkeleton)obj;
        //Out Envelop
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("calcTrueDps".equals(methodName)){
                ...
                net.dolusnomenhic.TrueDpsResponse trueDpsResponse1 = null;
	                        net.dolusnomenhic.TrueDpsRequest wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), trueDpsResponse1, false, new javax.xml.namespace.QName("http://dolusnomenhic.net",
                                                    "calcTrueDps"));
